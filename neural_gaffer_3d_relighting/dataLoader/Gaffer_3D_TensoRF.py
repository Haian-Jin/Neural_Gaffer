...
class Gaffer3D_TensoRF_Dataset(Dataset):
    ...
    def read_meta(self):
        ...
        for i in tqdm(idxs, desc=f'Loading data {self.split} ({len(idxs)})'):#img_list:#
            if self.split == 'train' :
                cam_trans_path = glob(os.path.join(self.raw_data_dir, f'{i:03d}_{0:03d}_*.npy'))[0] # specify lighting idx. here we specify 4
                ...
                image_path = glob(os.path.join(self.image_dir, f'{i:03d}_{0:03d}_*.png'))[0]
